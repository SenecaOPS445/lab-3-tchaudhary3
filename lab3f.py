...
if __name__ == '__main__':
    ...
    add_item_to_list(my_list)  # Add first item (last + 1)
    add_item_to_list(my_list)  # Add second item (last + 1)
    add_item_to_list(my_list)  # Add third item (last + 1)
    print(my_list)  # List after adding items
    remove_items_from_list(my_list, [1, 5, 6])  # Remove items 1, 5, 6
